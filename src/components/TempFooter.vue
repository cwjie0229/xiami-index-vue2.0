			...
			<div class="site-info">
				<div class="footer-explan clearfix">
					...
					<div class="explan-content">
						...
						<p class="explan-txt">
							&copy;<a href="//www.mi.com/index.html">mi.com</a> 京ICP证110507号 京ICP备10046444号 <a href="http://www.beian.gov.cn/portal/registerSystemInfo?recordcode=11010802020134" target="_blank">京公网安备11010802020134号 </a> <a href="//c1.mifile.cn/f/i/2013/cn/jingwangwen.jpg" target="_blank">京网文[2014]0059-0009号</a><br/>
...
.service .service-item:nth-last-child(1) {
    border-right: 0;
}
...
.footer-content .footer-itema {
        text-decoration: none;
        color: #333;
    }
.footer-content .footer-item:nth-last-child(2) {
        padding-right: 20px;
        border-right: 1px solid #e0e0e0;
    }
.footer-content .footer-item	h3 {
    ...
    .footer-content .footer-itemp {
        font-size: 12px;
        margin-top: 10px;
    }
.footer-content .footer-last-item {
		float: left;
		
	}
.footer-content .footer-last-item .col-content {
        margin-left: 40px;   
}
.footer-content .footer-last-item .col-content .phone-number {
    margin: 0 0 5px;
    font-size: 22px;
    text-align: center;
    margin-bottom: 5px;
...
.footer-content .footer-last-item .col-content .phone-desc {
    font-size: 12px;
    line-height: 1.5;
    text-align: center;
    color: #616161;
}
.footer-content .footer-last-item .col-content .server-btn {
    display: block;
    width: 120px;
    height: 30px;
    line-height: 30px;
...
.footer-content .footer-last-item .col-content .server-btn:hover {
    background: #ff6700;
    color: #fff;
}

 .footer-explan .logo-img {
		float: left;
		width: 57px;
		height: 57px;
	}
 .footer-explan .explan-content {
		float: left;
		padding-left: 10px;
		
	}
.footer-explan .explan-content  .links .link-item {
        float: left;
        padding: 0 5px;
        font-size: 12px;
        color: #757575;
 ...
 .footer-explan .explan-content  .links .link-item:nth-last-child(1) {
                border-right: 0;}
 .footer-explan .explan-txt {
		margin: 10px 0 0 5px;
		line-height: 18px;
		font-size: 12px;
		color: #b0b0b0;
	}
 .footer-explan .explan-txt a {
			text-decoration: none;
			color: #b0b0b0;}
 .footer-explan .explan-txt  a :hover {
				color: #ff6700;
			}
 .footer-explan .logo-explan {
		width: 85px;
		height: 28px;
	
	}
 .footer-explan .logo-explan.logo-explan-first {
			margin-left: 50px;
		}
.site-info {
	padding: 30px 0;
}
.site-info .footer-desc {
		text-align: left;
		text-indent: -9999em;
		overflow: hidden;
		width: 267px;
...
.link-item a:hover,dd a:hover, explan-txt a:hover{
	color:#FF6709;
}
</style>
