...
.header-search	.fadeOut-enter, .fadeOut-leave {
	  opacity: 0;
	}
...
.header-search	.search-btn	.icon-search:hover {
			background: #ff6700;
			
		}
.header-search	.search-btn	.icon-search		.icon-search {
...
.header-menu .menus	.product:nth-last-child(1) {
				a {
					border-right: 0;
				}
			}
